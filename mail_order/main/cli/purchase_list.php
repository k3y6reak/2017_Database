...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <?php
        ...
        $sql = "show columns from pur_list";
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3" style="margin-top10px;">
            <div class="card-header">
                <i class="fa fa-table"></i> Purchase List
            </div>
            <div class="card-body text-center">
                <div class="table-responsice">
                    <table class="table table-dark" id="db_list" width="100%" cellspacing="0">
                        ...
                        <?php
                            $sql = "select * from pur_list where cust_num=".$_SESSION['id_num'];
                            $result = mysql_query($sql);
                            if(!$result)
                            {
                                echo mysql_error();
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <th>
                                            <form method="post" action="./purchase_det.php">
                                                <?php
                                                    for($i=0; $i<count($column_name); $i++)
                                                    {
                                                ?>
                                                    <input type="hidden" name="<?=$column_name[$i]?>" value="<?=$row->$column_name[$i]?>">
<?php
                                                    }
                                                    ?>
