                        ...
                        <tr>
                            <th>
                               <?php echo $row->part_num;?>
                                ...
                                <input type="hidden" name="part_name<?=$count?>" value="<?=$row->part_name; ?>">
                                <input type="hidden" name="quantity<?=$count?>" value="<?=$row->quantity;?>">
                            </th>
                        </tr>
<?php
                        $count++;
            ...
            <?php
                $sql_confirm = "select * from pur_list where pur_num=".$row_pur->pur_num;
