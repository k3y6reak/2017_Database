...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">MAIL ORDER</a>
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3" style="margin-top10px;">
            <div class="card-header">
                <i class="fa fa-table"></i> Parts List
            </div>
                    ...
                    <table class="table table-dark" id="db_list" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <th>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#buy<?=$count;?>">Buy</button>
                                        </th>
                                        <?php
                                    ...
                                    <div class="modal" id="buy<?=$count?>" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="documnet">
                                            <div class="modal-content">
                                                <form method="post" action="./buy.php">
                                                    <div class="modal-header">
                                                        <input type="hidden" name="basket">
                                                        <input type="hidden" name="cust_num" value="<?=$_SESSION['id_num']?>">
                                                        <h5 class="modal-title">Buy List</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="part_name" class="col-sm-2 col-form-label">Quant</label>
                                                            <div class="col-sm-10">
