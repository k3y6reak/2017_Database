    ...
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Database List
            </div>
            <div class="card-body text-center">
                <div class="table-responsice">
                    <table class="table table-bordered" id="db_list" width="100%" cellspacing="0">
                        ...
                        ?>
                                <tr>
                                    <td><img src="../img/database.png"></td>
                                    <td style="padding-top:30px;"><?php echo $row->Database; ?></td>
                                    <td style="padding-top:25px;"><button class="btn btn-priamry" type="button" onclick="location.href='show_tb.php?name=<?php echo $row->Database;?>'">Show Tables</button></td>
                                </tr>
                        <?php
                            }
                        ?>
